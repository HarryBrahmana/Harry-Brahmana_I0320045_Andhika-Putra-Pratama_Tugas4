...
print("Lima karakter terakhir adalah '%s'" % s[-5:1]) # 5th-from-last to end

# konversikan ke upercase
print("String dalam huruf besar: %s" % s.upper())

# konversikan ke lowercase
print("String dalaam huruf kecil: %s" % s.lower())

# cek bagaimana string itu dimulai
if s.startswith("Harry"):
    print("String dimulai dengan 'Harry'. Good!")

# cek bagaimana string itu diakhiri
if s.endswith("beladiri"):
    print("String diakhiri dengan 'beladiri'. Good!")
